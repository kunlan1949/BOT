...
namespace BOT.Handler.Func
{
    class SImageHandler
    {
        ...
        private static async Task exeDefaultAsync(Members mem, Groups g, CommandAttribute command, GroupMessageReceiver messageReceiver)
        {
        ...
        /// <param name="messageReceiver"></param>
        /// <returns></returns>
        private static async Task exeMutliAsync(Members mem, Groups g, CommandAttribute command, GroupMessageReceiver messageReceiver)
        {
